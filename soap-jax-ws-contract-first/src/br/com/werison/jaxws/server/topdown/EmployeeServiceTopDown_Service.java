 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceTopDown", targetNamespace = "http://igastei.com.br/", wsdlLocation = "file:/C:/Workspaces/eclipse202006/soap-jax-ws-contract-first/employeeservicetopdown.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICETOPDOWN_QNAME = new QName("http://igastei.com.br/", "EmployeeServiceTopDown");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Workspaces/eclipse202006/soap-jax-ws-contract-first/employeeservicetopdown.wsdl");
    ...
    public EmployeeServiceTopDown getEmployeeServiceTopDownSOAP() {
        return super.getPort(new QName("http://igastei.com.br/", "EmployeeServiceTopDownSOAP"), EmployeeServiceTopDown.class);
    }
    ...
    public EmployeeServiceTopDown getEmployeeServiceTopDownSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://igastei.com.br/", "EmployeeServiceTopDownSOAP"), EmployeeServiceTopDown.class, features);
    }
