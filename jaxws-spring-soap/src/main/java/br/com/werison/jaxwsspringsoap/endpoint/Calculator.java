package br.com.werison.jaxwsspringsoap.endpoint;
...
import br.com.igastei.types.calculator.*;
...
public class Calculator {
    ...
    @ResponsePayload
    @PayloadRoot(namespace = "http://igastei.com.br/types/calculator", localPart = "AdditionInput")
    ...
    @ResponsePayload
    @PayloadRoot(namespace = "http://igastei.com.br/types/calculator", localPart = "SubtractionInput")
    ...
    @ResponsePayload
    @PayloadRoot(namespace = "http://igastei.com.br/types/calculator", localPart = "MultiplicationInput")
    ...
    @ResponsePayload
    @PayloadRoot(namespace = "http://igastei.com.br/types/calculator", localPart = "DivisionInput")
